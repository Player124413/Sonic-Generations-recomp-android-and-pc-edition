...
Физическая клавиатура (USB через OTG-переходник, Bluetooth или Chromebook)
работает сразу, без настройки: клавиши эмулируют геймпад Xbox 360.
Раскладка (есть и в приложении: кнопка **Keyboard controls**):
...
| Правый стик | I J K L |
| Крестовина | Стрелки |
| A / B | Пробел / Левый Shift |
| X / Y | F / R |
| LB / RB | Q / E |
| LT / RT | C / V (нажатие = полный ход) |
| L3 / R3 | Tab / Правый Shift |
| Start / Back | Enter / Backspace |
| Guide | Escape |

Раскладка не зависит от языка ввода (WASD — по физическому положению
клавиш). Экранный геймпад при игре с клавиатуры можно скрыть: шестерёнка
на нём → Hide. При сворачивании игры все зажатые клавиши отпускаются
автоматически.
